using Tyuiu.BatogovRK.Sprint6.Task2.V18.Lib;

namespace Tyuiu.BatogovRK.Sprint6.Task2.V18
{
    public partial class FormMain : Form
    {
        ...
        {
            MessageBox.Show("Таск выполнил Батогов Роман Константинович, АСОиУб-25-1");
        }
