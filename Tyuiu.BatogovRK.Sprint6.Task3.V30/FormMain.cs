using Tyuiu.BatogovRK.Sprint6.Task3.V30.Lib;

namespace Tyuiu.BatogovRK.Sprint6.Task3.V30
{
    public partial class FormMain : Form
    {
        ...
        {
            MessageBox.Show("Таск выполнил студент группы АСОиУб-25-1 Батогов Роман Константинович", "Сообщение", MessageBoxButtons.OK);
        }
    }
}
