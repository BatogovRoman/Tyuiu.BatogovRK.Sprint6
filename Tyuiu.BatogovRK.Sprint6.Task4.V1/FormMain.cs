...
namespace Tyuiu.BatogovRK.Sprint6.Task4.V1
{
    public partial class FormMain : Form
    {
        ...
        {
            MessageBox.Show("Таск выполнил студент группы АСОиУб-25-1 Батогов Роман Константинович");
        }
        private void buttonSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DialogResult dialogRes = MessageBox.Show("Файл " + path + " Сохранён успешно!\n Открыть его?");
